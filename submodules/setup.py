...
setup(
    name="gsplat",
    version=__version__,
    description=" Python package for differentiable rasterization of gaussians extended with NASG and NASGabor kernel for view-dependent appearance modeling.",
