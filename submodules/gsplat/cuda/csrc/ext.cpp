...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("compute_nasg_fwd", &gsplat::compute_nasg_fwd_tensor);
    m.def("compute_nasg_eval_fwd", &gsplat::compute_nasg_eval_fwd_tensor);
    m.def("compute_nasg_bwd", &gsplat::compute_nasg_bwd_tensor);

    m.def("compute_nasg_gabor_fwd", &gsplat::compute_nasg_gabor_fwd_tensor);
    m.def("compute_nasg_gabor_eval_fwd", &gsplat::compute_nasg_gabor_eval_fwd_tensor);
    m.def("compute_nasg_gabor_bwd", &gsplat::compute_nasg_gabor_bwd_tensor);
