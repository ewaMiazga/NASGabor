...
SHAPE_SIZE = {"nasg": 2, "nasg_gabor": 3}
    ...
    def __init__(self, parser, sentinel=False):
        ...
        if not sentinel:
            ...
            group.add_argument(
                ...
                type=str,
                default="nasg_gabor",
                choices=["nasg", "nasg_gabor"],
                help="GMM color mode: 'nasg' or 'nasg_gabor'. Default: 'nasg_gabor'.",
            )

    def extract(self, args):
        g = super().extract(args)
        g.source_path = os.path.abspath(g.source_path)
        g.gmm_color_mode = getattr(args, "gmm_color_mode", "nasg_gabor")
