...
setup(
    ...
    description="Python package for differentiable rasterization of deformable beta splatting, with CUDA NasGabor implementation.",
    keywords="beta, splatting, cuda, NASGabor",
    url="",
)
